...
cat("Attempting to cache all sesame data (may take several minutes)...\n")
tryCatch({
  sesameDataCache()
  cat("✓ All sesame data cached successfully\n")
}, error = function(e) {
  cat(paste("Warning: Bulk cache failed:", e$message, "\n"))
  cat("Falling back to individual file caching...\n")
  ...
  for (file in required_files) {
    tryCatch({
      ...
      cat(paste("  ✗ FAILED:", file, "-", e2$message, "\n"))
    })
  }
})

cat("Sesame cache setup complete\n")
